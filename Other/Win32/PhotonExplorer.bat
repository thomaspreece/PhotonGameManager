...
REM If you are worried about this file, either contact PhotonGameManager team for more info, or remove all the lines below (This will also stop Cabinet mode for PhotonExplorer)
