...
START "mt" /B /WAIT "mt.exe" -manifest "C:\GameManagerV4\manifest.txt" -outputresource:"C:\GameManagerV4\PhotonExplorer.exe";#1
START "mt" /B /WAIT "mt.exe" -manifest "C:\GameManagerV4\manifest.txt" -outputresource:"C:\GameManagerV4\PhotonFrontend.exe";#1