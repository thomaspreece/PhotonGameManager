...
Type SettingsWindow Extends wxFrame 
	...
	Function KeyboardWinFun(event:wxEvent)
		...
		SettingsWin.KeyboardInputField = KeyboardInputWindow(New KeyboardInputWindow.Create(SettingsWin, wxID_ANY, "FrontEnd Keyboard Input", , , 340, 520))	
	...
	Function JoyStickWinFun(event:wxEvent)
		Local SettingsWin:SettingsWindow = SettingsWindow(event.parent)
		PrintF("----------------------------Show Keyboard----------------------------")
		SettingsWin.JoyStickInputField = JoyStickInputWindow(New JoyStickInputWindow.Create(SettingsWin, wxID_ANY, "FrontEnd JoyStick Input", , , 340, 360))	
