...
Global RUNNERPROGRAM:String = Chr(34) + RealPath("PhotonRunner.app") + "/Contents/MacOS/PhotonUpdate" + Chr(34)
?
...
Global MOUNTERFOLDER:String = TempFolderPath + "Settings" + FolderSlash + "Mounters" + FolderSlash

Global DEFAULTMOUNTERFOLDER:String = "Mounters" + FolderSlash
